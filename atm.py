...
while True:
    ...
    if choiceNumber == "5":
        ...
        name = input("Input Fullname : ")
        customerNames.append(name)
        Oldpin = str(input("Please enter of your OldPin : "))
        pin = str(input("Please input a New pin ,how you Want : "))
        customerPins.append(pin)
        print("Your New pin is added to customer system")
        print("----New Atm Pin  Added successfully !----")
        print("\n")
        print("Note! Please remember The Name and Pin")
        print("========================================")
